...
//
//        // Acacia
//        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.FRAMED_WINDOW_ACACIA_CLEAR_1.get())
//                .requires(Blocks.ACACIA_PLANKS)
//                .requires(Blocks.GLASS)
//                .unlockedBy("has_acacia_planks", has(Blocks.ACACIA_PLANKS))
//                .save(recipeOutput);
//        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.FRAMED_WINDOW_ACACIA_CLEAR_2_PARA.get())
//                .pattern(" A ")
//                .pattern(" G ")
//                .pattern(" A ")
...
//                .unlockedBy("has_acacia_planks", has(Blocks.ACACIA_PLANKS))
//                .save(recipeOutput);
//        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.FRAMED_WINDOW_ACACIA_CLEAR_2_CORNER.get())
//                .requires(Blocks.ACACIA_PLANKS, 2)
//                .requires(Blocks.GLASS)
//                .unlockedBy("has_acacia_planks", has(Blocks.ACACIA_PLANKS))
//                .save(recipeOutput);
//        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.FRAMED_WINDOW_ACACIA_CLEAR_3.get())
//                .requires(Blocks.ACACIA_PLANKS, 3)
//                .requires(Blocks.GLASS)
//                .unlockedBy("has_acacia_planks", has(Blocks.ACACIA_PLANKS))
//                .save(recipeOutput);
//        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.FRAMED_WINDOW_ACACIA_CLEAR_4.get())
